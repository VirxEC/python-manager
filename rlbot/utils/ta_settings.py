...
TAGAME_CONFIG_LOCATION = os.path.expanduser(
...
def merge():
    ...
    TASystemSettings_user_path = os.path.join(
        TAGAME_CONFIG_LOCATION, "TASystemSettings.user.ini"
    )
    TASystemSettings_RLBot_path = os.path.join(
        TAGAME_CONFIG_LOCATION, "TASystemSettings.RLBot.ini"
    )
